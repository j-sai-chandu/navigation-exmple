...
use Costar\LogViewer\Contracts\Utilities\Filesystem;
...
return [
    ...
    'route' => [
        ...
        //     'middleware' => env('COSTAR_LOGVIEWER_MIDDLEWARE') ? explode(',', env('COSTAR_LOGVIEWER_MIDDLEWARE')) : null,
        // ],
    ],
