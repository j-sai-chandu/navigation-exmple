    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <x-frontend.card :url="$details_url" :name="$$module_name_singular->name" :image="$$module_name_singular->featured_image">
            ...
            <div class="flex flex-row items-center my-4">
                <images class="w-5 h-5 sm:w-8 sm:h-8 rounded-full" src="{{asset('images/avatars/'.rand(1, 8).'.jpg')}}" alt="Author profile image">
            ...
            @else
            <div class="flex flex-row items-center my-4">
                <images class="w-5 h-5 sm:w-8 sm:h-8 rounded-full" src="{{asset('images/avatars/'.rand(1, 8).'.jpg')}}" alt="">
