...
<x-backend-breadcrumbs>
    <x-backend-breadcrumb-item route='{{route("backend.subjects.index")}}' icon='{{ $module_icon }}'>
        {{ __($module_title) }}
    ...
    <div class="card-body">
        ...
        <x-backend.section-header>
            ...
            <x-slot name="toolbar">
                ...
                <a href="{{ route('backend.subjects.index') }}" class="btn btn-secondary" data-toggle="tooltip" title="{{ ucwords($module_name) }} List"><i class="fas fa-list"></i> List</a>
