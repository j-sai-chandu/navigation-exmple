...
<section class="mx-auto flex md:flex-row flex-col bg-white text-gray-600 p-8">
            ...
            <dl class="mb-5 section-scroll-step" id="{{$group_data['taxon']['slug']}}">
                ...
                <dd class="grid grid-cols-1 sm:grid-cols-4 gap-6">
                    @foreach ($group_data['subject'] as $index => $data)
                        ...
                        @endphp
                        <div 
                            class="flex flex-col p-3 bg-white border border-gray-100 rounded-lg hover:shadow-lg dark:bg-gray-800 dark:border-gray-700"
                            data-toggle="tooltip" 
