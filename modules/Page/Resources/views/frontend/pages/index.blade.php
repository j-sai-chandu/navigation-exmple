                ...
                <div class="w-full mx-auto flex flex-col items-center justify-center border border-gray-200 rounded-md hover:shadow-lg">
                    ...
                    <ul class="w-full py-3">
                        ...
                        <li class="flex items-center flex-row flex-1 transition duration-500 ease-in-out transform hover:-translate-y-1 px-6 py-3">
                            <a href="{{$detail_url}}" class="block relative flex w-full"> 
                                <div class="flex-0-0-48 flex justify-center items-center mr-4">
                                    ...
                                    @else
                                    <x-image-placeholder width='48' height='40' text="Costar" fontSize="12px" class="transform hover:scale-110 duration-300 rounded" />
                                    @endif
                                </div>
                                <div class="flex-1">
                                    <div class="text-base">
