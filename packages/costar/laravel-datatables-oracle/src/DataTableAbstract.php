...
use Costar\DataTables\Contracts\DataTable;
use Costar\DataTables\Contracts\Formatter;
use Costar\DataTables\Processors\DataProcessor;
 ...
 *
 * @see https://github.com/costar/laravel-datatables-fractal for transformer related methods.
 */
abstract class DataTableAbstract implements DataTable
{
    ...
    /**
     * @var \Costar\DataTables\Utilities\Config
     */
     ...
     * @param  string|callable|\Costar\DataTables\Contracts\Formatter  $formatter
     * @return $this
     */
    ...
    {
        if (isset($this->transformer) && class_exists('Costar\\DataTables\\Transformers\\FractalTransformer')) {
     ...
     * @return \Illuminate\Http\JsonResponse
     *
     * @throws \Costar\DataTables\Exceptions\Exception|\Exception
     */
