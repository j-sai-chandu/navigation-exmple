...
namespace Costar\DataTables;

use Illuminate\Contracts\Database\Eloquent\Builder as EloquentBuilder;
use Illuminate\Contracts\Database\Query\Builder as QueryBuilder;
use Illuminate\Support\Traits\Macroable;
use Costar\DataTables\Exceptions\Exception;
use Costar\DataTables\Html\Builder;
...
class DataTables
{
     ...
     *
     * @var \Costar\DataTables\Utilities\Request
     */
     ...
     *
     * @var \Costar\DataTables\Html\Builder|null
     */
        ...
        foreach ($builders as $class => $engine) {
            if ($source instanceof $class) {
                ...
                if (is_callable($callback)) {
                    /** @var \Costar\DataTables\DataTableAbstract $instance */
     ...
     * Get request object.
     *
     * @return \Costar\DataTables\Utilities\Request
     */
     ...
     * Get config instance.
     *
     * @return \Costar\DataTables\Utilities\Config
     */
     ...
     * @return \Costar\DataTables\QueryDataTable
     */
     ...
     * @return \Costar\DataTables\EloquentDataTable
     */
     ...
     * @return \Costar\DataTables\CollectionDataTable
     */
     ...
     *
     * @return \Costar\DataTables\Html\Builder
     *
     * @throws \Costar\DataTables\Exceptions\Exception
     */
    public function getHtmlBuilder()
    {
        if (! class_exists(Builder::class)) {
            throw new Exception('Please install costar/laravel-datatables-html to be able to use this function.');
        }
