...
namespace Costar\Modules\Facades;
 ...
 * @method  array scan()
 * @method  \Costar\Modules\Collection toCollection()
 ...
 * @method  \Costar\Modules\Module find(string $name)
 * @method  \Costar\Modules\Module findOrFail(string $name)
