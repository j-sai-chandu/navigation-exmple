...
use Costar\Modules\Exceptions\InvalidAssetPath;
use Costar\Modules\Exceptions\ModuleNotFoundException;
use Costar\Modules\Process\Installer;
use Costar\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @return string
     * @throws \Costar\Modules\Exceptions\ModuleNotFoundException
     */
