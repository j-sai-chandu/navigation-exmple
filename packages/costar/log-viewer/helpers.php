...
use Costar\LogViewer\Contracts;

if ( ! function_exists('log_viewer')) {
    /**
     * Get the LogViewer instance.
     *
     * @return Costar\LogViewer\Contracts\LogViewer
     */
    function log_viewer()
    {
...
if ( ! function_exists('log_menu')) {
     ...
     *
     * @return Costar\LogViewer\Contracts\Utilities\LogMenu
     */
    function log_menu()
    {
...
if ( ! function_exists('log_styler')) {
     ...
     *
     * @return Costar\LogViewer\Contracts\Utilities\LogStyler
     */
    function log_styler()
    {
