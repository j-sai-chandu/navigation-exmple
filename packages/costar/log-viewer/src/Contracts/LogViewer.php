...
namespace Costar\LogViewer\Contracts;
...
interface LogViewer extends Patternable
{
     ...
     * Get all logs.
     *
     * @return \Costar\LogViewer\Entities\LogCollection|\Costar\LogViewer\Entities\Log[]
     */
    public function all();
     ...
     * @return bool
     *
     * @throws \Costar\LogViewer\Exceptions\FilesystemException
     */
