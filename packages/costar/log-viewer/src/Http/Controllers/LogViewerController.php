...
namespace Costar\LogViewer\Http\Controllers;

use Costar\LogViewer\Contracts\LogViewer as LogViewerContract;
use Costar\LogViewer\Entities\{LogEntry, LogEntryCollection};
...
class LogViewerController extends Controller
{
     ...
     * @param  string  $date
     *
     * @return \Costar\LogViewer\Entities\Log|null
     */
     ...
     * Prepare chart data.
     *
     * @param  \Costar\LogViewer\Tables\StatsTable  $stats
     *
     * @return string
     */
