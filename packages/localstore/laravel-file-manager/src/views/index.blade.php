...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('vendor/bootstrap/bootstrap@4.1.0-min.css') }}">
  <link rel="stylesheet" href="{{ asset('vendor/fontawesome-free/css/all.min.css') }}">
  <link rel="stylesheet" href="{{ asset('vendor/jquery-ui/jquery-ui@1.12.1-min.css') }}">
...
<body>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('localstore.lfm.upload') }}" role='form' id='uploadForm' name='uploadForm' method='post' enctype='multipart/form-data' class="dropzone">
  ...
  <script src="{{ asset('vendor/popper/popper@1.12.3-min.js') }}"></script>
  <script src="{{ asset('vendor/bootstrap/bootstrap@4.1.0-min.js') }}"></script>
  <script src="{{ asset('vendor/jquery-ui/jquery-ui@1.13.2-min.js') }}"></script>
