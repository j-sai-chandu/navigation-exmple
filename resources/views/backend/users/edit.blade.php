    ...
    <div class="row mt-4">
        <div class="col">
            ...
            <div class="row mb-3">
                <?php
                $field_name = 'email';
                $field_label = __('labels.backend.users.fields.email');
            ...
            <div class="row mb-3">
                <?php
                $field_name = 'password';
                $field_label = __('labels.backend.users.fields.password');
                $field_placeholder = $field_label;
                $required = "required";
                ?>
                <div class="col-12 col-sm-2">
            ...
            <div class="row mb-3">
                ...
                $field_label = __('labels.backend.users.fields.confirmed');
                $field_placeholder = $field_label;
                $required = "";
                ?>
                <div class="col-12 col-sm-2">
            ...
            <div class="row mb-3">
                <?php
                $field_name = 'social';
                $field_label = __('labels.backend.users.fields.social');
                $field_placeholder = $field_label;
                $required = "";
                ?>
                <div class="col-12 col-sm-2">
