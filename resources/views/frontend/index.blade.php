    ...
    <div class="container mx-auto px-1 sm:px-20 py-20 flex md:flex-row flex-col items-center">
        ...
        <div class="flex flex-col lg:flex-grow md:items-start md:text-left items-center text-center md:w-3/5 w-2/3 px-4 md:pl-8">
            ...
            <div class="flex justify-center">
                <a href="https://github.com/kothing/laravel-costar" class="inline-flex text-white bg-gray-700 border-0 py-2 px-6 focus:outline-none hover:bg-gray-800 rounded text-lg">
                ...
                <a href="https://github.com/kothing/laravel-costar" class="ml-4 outline outline-1 outline-gray-800 inline-flex text-gray-700 hover:text-gray-100 bg-gray-200 hover:bg-gray-700 py-2 px-6 focus:outline-none rounded text-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="w-8 h-8" viewBox="0 0 18 18">
