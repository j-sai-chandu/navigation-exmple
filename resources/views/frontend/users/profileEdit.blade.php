            ...
            <div class="px-4 sm:px-0">
                ...
                <div class="pt-4 text-center">
                    <a href='{{ route("frontend.users.profile", encode_id($$module_name_singular->id)) }}'>
                        <div class="w-full font-semibold text-sm px-6 py-2 transition ease-in duration-200 rounded text-gray-500 bg-gray-100 hover:bg-gray-800 hover:text-white border-1 border-gray-900 focus:outline-none">
                            @lang('View Profile')
                        </div>
                    </a>
                </div>
            ...
            <div class="mb-8 p-6 bg-white border rounded-lg">
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        $required = "required";
                        ?>
                        {{ html()->label($field_label, $field_name)->class('block-inline text-sm font-medium text-gray-700') }} {!! field_required($required) !!}
            ...
            <div class="mb-8 p-6 bg-white border rounded-lg">
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        ?>
                        {{ html()->label($field_label, $field_name)->class('block text-sm font-medium text-gray-700') }} {!! field_required($required) !!}
